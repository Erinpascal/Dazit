...
<strong>Success</strong> {{Session::get('success_message')}}
        ...
        @if(Cart::count() > 0)
            ...
            @foreach(Cart::content() as $item)
                <li class="pr-cart-item">
                    ...
                    <div class="price-field produtc-price"><p class="price">Gh{{$item->model->regular_price}}</p></div>
                    <div class="quantity">
        ...
        <div class="summary">
            <div class="order-summary">
                ...
                <p class="summary-info"><span class="title">Subtotal</span><b class="index">Gh {{Cart::subtotal()}}</b></p>
                <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
                <p class="summary-info total-info "><span class="title">Total</span><b class="index">Gh {{Cart::total()}}</b></p>
            </div>
